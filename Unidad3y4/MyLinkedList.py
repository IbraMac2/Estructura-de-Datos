...
def main():
    lista = None
    lista = agregar_al_final(lista, "Ibrahim")
    lista = agregar_al_final(lista, "Macedo")
    lista = agregar_al_inicio(lista, "Link")
    print("Antes de eliminar: ")
    imprimir_lista(lista)  # Link, Ibrahim, Macedo
    lista = eliminar(lista, "Link")
    print("Después de eliminar: ")
    imprimir_lista(lista)  # Ibrahim, Macedo
    print(existe(lista, "Link"))  # False
    print(existe(lista, "Ibrahim"))  # True
    print(obtener_cabeza(lista).dato)  # Ibrahim
    print(obtener_cola(lista).dato)  # Macedo
